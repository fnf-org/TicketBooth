...
Rails.application.config.assets.paths << Rails.root.join('node_modules/@hotwired')
Rails.application.config.assets.paths << Rails.root.join('node_modules/@stripe')
Rails.application.config.assets.paths << Rails.root.join('node_modules/@popperjs')
