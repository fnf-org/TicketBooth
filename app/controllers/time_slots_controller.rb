...
class TimeSlotsController < ApplicationController
  ...
  def create
    params[:time_slot][:start_time] = TimeHelper.from_flatpickr(params.delete(:start_time))
    params[:time_slot][:end_time] = TimeHelper.from_flatpickr(params.delete(:end_time))
