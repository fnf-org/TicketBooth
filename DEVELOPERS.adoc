...
You should be able to login or signup for an account year around, but only when an event is active and open for ticket requests will you be able to actually submit ticket requests.
